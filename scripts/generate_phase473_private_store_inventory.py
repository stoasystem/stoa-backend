...
BRANCH_CONTRACTS: dict[str, dict[str, Any]] = {
    ...
    "attachments": {"roots": ["UPLOAD#", "ATTACHMENT#", "s3://server-private/attachments/"], "subfamilies": ["intent", "association", "immutable_object"]},
    ...
    "report_artifacts": {"roots": ["REPORT_OBJECT#", "s3://server-private/reports/"], "subfamilies": ["object_intent", "version", "retention"]},
