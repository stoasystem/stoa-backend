...
class Settings(BaseSettings):
    ...
    # The conversation generation worker's alias (#18). Set, a message's answer
    # is generated by the worker and the request returns once the message is
    # stored; empty, the answer is generated in the request. Unsetting it is
    # the rollback.
    conversation_generation_function_name: str = ""
