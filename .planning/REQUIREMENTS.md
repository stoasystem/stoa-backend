...
- [ ] **V9PRIV-01:** Question OCR accepts only an existing, unconsumed upload owned by the authenticated student and atomically associates it with the created question.
...
- [ ] **V9PRIV-03:** Student practice preview, overview, path, and lesson responses never expose correct answers or answer-derived explanations before a recorded submission.
