...
| --- | --- | --- | --- |
| 472 | Privileged Identity And Student Resource Authorization | Close both P0 findings and harden token/client trust | Audit baseline |
| 473 | Student Content Privacy And Practice Integrity | Enforce upload ownership and remove pre-answer leakage | Phase 472 |
