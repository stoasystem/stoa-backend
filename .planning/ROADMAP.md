...
- **v5.20 Native Build Distribution And Device QA**: turn the v5.19 mobile implementation into internal device builds, physical-device QA, native credential evidence, crash/performance telemetry, and store-release readiness.
