...
- [x] `474-84` — Remove browser EmailJS contact fallback.
...
- [x] `474-93` — Replacement owner-approved exact source handoff after formal-snapshot path repair.
