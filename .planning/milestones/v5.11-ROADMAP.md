...
- [ ] **Phase 227: Usage Action Taxonomy And Ledger Contract** - Define governed actions, success/skip rules, idempotency keys, privacy schema, and summary groups.
...
|-------|-----------|----------------|--------|-----------|
| 227 Usage Action Taxonomy And Ledger Contract | v5.11 | 0/1 | Planned | - |
